...
namespace Sistema_Control_Entrada_Salida_QR.Pages.Modulo_Guardas.Validacion_QR
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostValidarQRAsync([FromForm] string qr)
        {
            ...
            {
                return new JsonResult(new { error = "C�digo QR inv�lido." });
            }
...
ORDER BY c.Fecha_generacion DESC;";
            ...
            if (persona == null)
            {
                return new JsonResult(new { error = "C�digo QR inv�lido o expirado." });
            }
